...
def main():
    ...
    print("   ✅ Умные задержки распознавания:")
    print("      🟢 Известные лица: 3 секунды")
    print("      🔴 Неизвестные лица: 5 секунд (защита от спама)")
    print("   ✅ Автоочистка информации (2 сек)")
    print("   ✅ Статистика в реальном времени")
    print("   ✅ Цветовые индикаторы состояний:")
    print("      🟢 Зеленая рамка - распознан")
    print("      🟠 Оранжевая рамка - ожидание (известный)")  
    print("      🟣 Фиолетовая рамка - блокировка (неизвестный)")
    print("      🔴 Красная рамка - неизвестный пользователь")
