...
import pickle  # Сериализация Python объектов для хранения в БД
...
class DatabaseManager:
    ...
    def __init__(self, db_name=USERS_DB):
        ...
        Создает подключение к SQLite базе данных и инициализирует
    ...
    def add_user(self, user_id, name, photo_path, face_encoding=None):
        ...
        Args:
            ...
            face_encoding (numpy.ndarray, optional): 128-мерный вектор признаков лица
        ...
        try:
            ...
            if face_encoding is not None:
                # Преобразование numpy массива в бинарные данные через pickle
    ...
    def get_all_facial_encodings(self):
        ...
        Returns:
            tuple: Кортеж из двух синхронизированных списков:
                - encodings (list): Список numpy массивов с отпечатками лиц
        ...
        for user_id, encoding_blob in results:
            if encoding_blob:
                # Восстановление numpy массива из бинарных данных
    ...
    def get_user_by_id(self, user_id):
        ...
        Returns:
            tuple or None: Кортеж с данными пользователя (id, user_id, name, photo_path, face_encoding)
